...
(2, 'admin', '$2a$10$pz916cL5nZa7hoSQ7/tadeI.i9wSELV9knz6n3NiKLetpw6k8Uun2', 'Admin', '/analytics', 1),
...
('欢迎使用系统', '您已成功登录 Vben Admin 系统，开始您的工作吧！', 'https://avatar.vercel.sh/vercel.svg?text=VB', '/analytics', 1, 1, 'info'),
...
('欢迎使用系统', '您已成功登录 Vben Admin 系统作为管理员。', 'https://avatar.vercel.sh/vercel.svg?text=VB', '/analytics', 0, 2, 'info'),
('权限变更通知', '您的管理员权限已更新，请重新登录以刷新权限。', 'https://avatar.vercel.sh/1', NULL, 0, 2, 'warning'),
('欢迎使用系统', '您已成功登录 Vben Admin 系统作为普通用户。', 'https://avatar.vercel.sh/vercel.svg?text=VB', '/analytics', 0, 3, 'info');
